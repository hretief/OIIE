...
/// what a reset means — sessions, channels, tables and reference data, in that order —
/// and reimplementing that ordering behind a button would create a second definition
/// free to drift from the first. It also keeps the admin-key guard on the path it
/// protects instead of quietly bypassing it.
/// </summary>
...
{
    /// <summary>
    /// Tears down and rebuilds participant state: tables, reference data, and this
    /// deployment's own ISBM channels.
    /// </summary>
